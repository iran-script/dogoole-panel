<div>
    @section('title-b',__('index.list shipment type'))
                            ...
                            @if($deliveryTypes)
                                @forelse($deliveryTypes as $deliveryType)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{route('admin.deliveryType.edit',$deliveryType['id'])}}"
                                            ...
                                            <a onclick="destroy({{$deliveryType['id']}})"
                                               class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm m-1">
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            <div class="text-center pb-15 px-5">
                                                <img src="{{asset('panel/assets/media/illustra   tions/sketchy-1/2.png')}}"
                                                     alt=""
