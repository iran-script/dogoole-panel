<div>
    @section('title-b',__('index.edit product'))
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="mb-10 fv-row col-12 p-1 float-start text-start">
                                    ...
                                    @if($user['role_id']==1 || $user['role_id']==6)
                                        <label class="required form-label">{{ __('index.product status') }}</label>
                                        ...
                                        <div class="error mt-4"> @error('productStatus') {{ $message }} @enderror</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-10 fv-row col-md-3 p-1 float-start text-center">
                                <div class="image-input-wrapper w-150px h-150px m-auto">
                                    ...
                                    @else
                                        @if($beforeImage1)
                                            <img class="img-fluid" src="{{$beforeImage1}}">
                                        @else
                                            <img class="img-fluid"
                                                 src="{{ asset('panel/assets/media/svg/files/blank-image.svg')}}">
                                        @endif
                            ...
                            <div class="mb-10 fv-row col-md-3 p-1 float-start text-center">
                                <div class="image-input-wrapper w-150px h-150px m-auto">
                                    ...
                                    @else
                                        @if($beforeImage2)
                                            <img class="img-fluid" src="{{$beforeImage2}}">
                                        @else
                                            <img class="img-fluid"
                                                 src="{{ asset('panel/assets/media/svg/files/blank-image.svg')}}">
                                        @endif
                            ...
                            <div class="mb-10 fv-row col-md-3 p-1 float-start text-center">
                                <div class="image-input-wrapper w-150px h-150px m-auto">
                                    ...
                                    @else
                                        @if($beforeImage3)
                                            <img class="img-fluid" src="{{$beforeImage3}}">
                                        @else
                                            <img class="img-fluid"
                                                 src="{{ asset('panel/assets/media/svg/files/blank-image.svg')}}">
                                        @endif
                            ...
                            <div class="mb-10 fv-row col-md-3 p-1 float-start text-center">
                                <div class="image-input-wrapper w-150px h-150px m-auto">
                                    ...
                                    @else
                                        @if($beforeImage4)
                                            <img class="img-fluid" src="{{$beforeImage4}}">
                                        @else
                                            <img class="img-fluid"
                                                 src="{{ asset('panel/assets/media/svg/files/blank-image.svg')}}">
                                        @endif
