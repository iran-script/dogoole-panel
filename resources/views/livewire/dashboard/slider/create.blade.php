<div>
    @section('title-b',__('index.creat slider'))
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row col-12 col-md-6 p-1 float-start">
                                <label class="required form-label">{{ __('index.type') }}</label>
                                <select class="form-select mb-2" wire:model="type">
                                    <option value="null">{{__('index.select')}}</option>
                                    <option value="home">{{__('index.home')}}</option>
                                    <option value="product_search">{{__('index.product_search')}}</option>
                                    <option value="chef_search">{{__('index.chef_search')}}</option>
                                </select>
                            ...
                            <div class="mb-10 fv-row col-12 col-md-6 p-1 float-start">
                                ...
                                <input wire:model="link" type="text" class="form-control fs-3 mb-2"/>
                                <div class="error mt-4"> @error('link') {{ $message }} @enderror</div>
                            </div>


                            {{--                            <div class="mb-10 fv-row col-12 col-md-6 p-1 float-start">--}}
                            {{--                                @livewire("dashboard.component.product-search-drop-down",['var'=>'productId'])--}}
                            {{--                            </div>--}}
