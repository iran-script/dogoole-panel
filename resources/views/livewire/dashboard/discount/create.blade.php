                        ...
                        <div class="card-body">
                            ...
                            <div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary">
                                <div class="mb-10 fv-row col-sm-12 col-md-12 col-12 p-1 float-start">
                                    <label class="required form-label">{{ __('index.set limit discount code for users') }}</label>
                            ...
                            <div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary">
                                <div class="mb-10 fv-row col-sm-12 col-md-12 col-12 p-1 float-start">
                                    <label class="required form-label">{{ __('index.set limit discount code for branch') }}</label>
                            ...
                            <div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary">
                                <div class="mb-10 fv-row col-sm-12 col-md-12 col-12 p-1 float-start">
                                    <label class="required form-label">{{ __('index.set limit discount code for city') }}</label>
                                    <select disabled class="form-select mb-2" wire:model="limitBranchStatus">
                                        <option value="true">{{__('index.true')}}</option>
                                        <option value="false">{{__('index.false')}}</option>
                                    </select>
                    ...
                    <div class="card card-bordered">
                        ...
                        <div class="card-body">
                            <div class="mb-10 fv-row col-12 p-1 float-start">
                                @livewire("dashboard.component.datepicker",['showDescriptionText'=>false,'requirment'=>true])
                            </div>
                            <div class="mb-10  col-md-6 p-1 float-md-start">
                            ...
                            <div class="mb-10 col-12 col-md-6 p-1 float-md-start">
                            ...
                            @if($limitUseStatus==="true")
                                <div class="mb-10 col-6 col-sm-6p-1 float-md-start">
                            ...
                            @if($limitUserStatus=="true")
                                <div class="mb-10 col-6 col-md-6 p-1 float-start">
                            ...
                            @if($limitBranchStatus=="true")
                                <div class="mb-10 col-12 col-md-6 p-1 float-start">
                            ...
                            <div class="col-12 col-md-6 float-md-start">
                                <div class="mb-10 fv-row col-12 col-sm-12 col-md-6 col-6 p-1 float-start">
                            ...
                            <div class="mb-10 fv-row col-sm-12 col-md-6 p-1 float-md-start">
